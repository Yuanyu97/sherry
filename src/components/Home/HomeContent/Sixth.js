...
import SixthPic from '../../../../public/sherry/sixth.jpg'
    ...
    const textComponent = (
        <div className={classes.typoItem}>
            ...
            <Typography variant='h6' style={{ marginTop: '10px' }}>
                {"2024 was not the best year for me, but it did end off very strong, because I met you :-) And I hope I make you happy too hehehe 2025 蛇年 gonna be our year!! ps. 这照片超好看的, NICE! "}
            </Typography>
        </div>
    )
        ...
        <Fragment>
            <Grid className={classes.containerDesktop} container='true' justify='flex-end'>
                <Grid item xs={6} data-aos='fade-right'>
                    <Image style={{ height: '100%', width: '50%' }} src={SixthPic} alt='MusicMockUp' />
                </Grid>
