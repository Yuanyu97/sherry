...
import FifthPic from '../../../../public/sherry/fifth.jpg'
    ...
    const textComponent = (
        <div className={classes.typoItem}>
            ...
            <Typography variant='h6' style={{ marginTop: '10px' }}>
                {"Couldn't have asked for a better company for this hehehe And I like this photo A LOT so cute!! I realised from this pic that you like to take sneaky cute moments hehe 很可爱, 你让我很开心 :-)"}
            </Typography>
        </div>
    )
        ...
        <Fragment>
            ...
            <Grid className={classes.containerDesktop} container='true' justify='flex-end'>
                ...
                <Grid item xs={6} className={classes.imgGridItem} data-aos='fade-left'>
                    <Image style={{ height: '100%', width: '50%' }} src={FifthPic} alt='EditMockUp' />
                </Grid>
            </Grid>
            {/* for mobile display */}
