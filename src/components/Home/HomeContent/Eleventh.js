...
import EleventhPic from '../../../../public/sherry/eleventh.jpg'
    ...
    const textComponent = (
        <div className={classes.typoItem}>
            ...
            <Typography variant='h6' style={{ marginTop: '10px' }}>
                {"Wanted to add my personal favourite of 扮鬼脸 faces together hehehe"}
            </Typography>
        </div>
    )
        ...
        <Fragment>
            ...
            <Grid className={classes.containerDesktop} container='true' justify='flex-end'>
                ...
                <Grid item xs={6} className={classes.imgGridItem} data-aos='fade-left'>
                    <Image style={{ height: '100%', width: '50%' }} src={EleventhPic} alt='EditMockUp' />
                </Grid>
            </Grid>
            {/* for mobile display */}
            <Stack className={classes.containerMobile} container='true' data-aos='fade'>
                {textComponent}
                <Image style={{ height: '100%', width: '50%', marginTop: '10%' }} src={EleventhPic} alt='MusicMockUp' />
            </Stack>
        </Fragment>
    )
}