...
import FourthPic from '../../../../public/sherry/fourth.jpg'
    ...
    const textComponent = (
        <div className={classes.typoItem}>
            ...
            <Typography variant='h6' style={{ marginTop: '10px' }}>
                {"Honestly so fun, even though we couldn't rollerblade for nuts BUT HEY WIP RIGHT! However, the highlight of that day wassss"}
            </Typography>
        </div>
    )
        ...
        <Fragment>
            <Grid className={classes.containerDesktop} container='true' justify='flex-end'>
                <Grid item xs={6} data-aos='fade-right'>
                    <Image style={{ height: '100%', width: '50%' }} src={FourthPic} alt='MusicMockUp' />
                </Grid>
